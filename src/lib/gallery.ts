...
export type GalleryFolder = "base-decals" | "partial-wraps" | "full-wraps" | "fleet-programs" | "specialty-services" | "trailers";
...
export function getAllGalleryImages(): CategoryImages {
  return {
    ...
    "trailers":          getImagesForFolder("trailers"),
  };
}
...
export const FALLBACK_IMAGES: CategoryImages = {
  ...
  "trailers":           ["/trucks/full-coverage.jpg"],
};
