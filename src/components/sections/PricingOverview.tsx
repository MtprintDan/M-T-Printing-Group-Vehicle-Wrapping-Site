...
const plans = [
  {
    ...
    vehicles: [
      { label: "Standard", price: "$470" },
      { label: "Medium", price: "$545" },
      { label: "Large", price: "$685" },
      { label: "Oversized", price: "$950" },
    ],
    builderNote: "Basic Graphic Setup and Installation Included",
    popular: true,
  ...
  },
  {
    ...
    vehicles: [
      { label: "Standard", price: "$1,230" },
      { label: "Medium", price: "$1,599" },
      { label: "Large", price: "$2,200" },
      { label: "Oversized", price: "$2,750" },
    ],
    builderNote: "Basic Graphic Setup and Installation Included",
    popular: false,
  ...
  },
  {
    ...
    vehicles: [
      { label: "Standard", price: "$2,830" },
      { label: "Medium", price: "$4,060" },
      { label: "Large", price: "$5,200" },
      { label: "Oversized", price: "$7,750" },
    ],
    builderNote: "Advanced Graphic Design, Setup and Installation Included",
    popular: false,
              ...
              >
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    {/* Vehicle Sizing Rates */}
                    <div className={`rounded-xl p-4 mb-4 ${plan.popular ? "bg-white/5" : "bg-gray-50"}`}>
                      <p className={`text-[10px] font-bold uppercase tracking-widest mb-3 ${plan.popular ? "text-gray-500" : "text-gray-400"}`}>
                        Vehicle Sizing Rates
                      </p>
                      {plan.vehicles.map((v) => (
                        <div
                    ...
                    {/* Builder note above CTA */}
                    <p className={`text-[11px] mb-3 ${plan.popular ? "text-gray-500" : "text-gray-400"}`}>
                      {plan.builderNote}
                    </p>
