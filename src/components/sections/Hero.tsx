...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-white pt-[144px]">
      ...
      {/* Subtle animated CMYK background blobs */}
      <motion.div
        animate={{ x: [0, 30, 0], y: [0, -20, 0], scale: [1, 1.2, 1] }}
        transition={{ duration: 18, repeat: Infinity, ease: "easeInOut" }}
        className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(0,174,239,0.05) 0%, transparent 70%)" }}
      />
      <motion.div
        ...
        style={{ background: "radial-gradient(circle, rgba(236,0,140,0.04) 0%, transparent 70%)" }}
      />
      <motion.div
        animate={{ x: [0, 20, 0], y: [0, -15, 0], scale: [1, 1.1, 1] }}
        transition={{ duration: 15, repeat: Infinity, ease: "easeInOut", delay: 8 }}
        className="absolute top-2/3 right-1/3 w-64 h-64 rounded-full pointer-events-none"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            >
              ...
              <span className="text-brand-black font-semibold">$470</span>. Turn your fleet into a
              moving billboard.
            </motion.p>
          ...
          >
            ...
            <Link href="/#pricing" className="block group">
              <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#f0f9ff] to-[#f8fafc] border-2 border-[#00AEEF] shadow-2xl group-hover:shadow-[0_20px_60px_rgba(0,174,239,0.2)] transition-shadow duration-300">
                {/* Hero vehicle image — drop /public/front-page-example/hero.png to activate */}
                <div className="relative aspect-[16/9]">
                  ...
                  <div className="relative w-full h-full">
                    <Image
                      src="/front-page-example/hero.png"
                      alt="Vehicle wrap example"
                      fill
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-xl px-3 py-2 shadow-sm border border-gray-100">
                  <p className="text-[10px] font-bold uppercase tracking-widest text-[#00AEEF]">Ford Transit</p>
            ...
            >
              ...
              <p className="text-2xl font-black text-brand-black">$470</p>
