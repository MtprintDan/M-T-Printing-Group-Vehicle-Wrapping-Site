...
const megaMenu = [
  {
    ...
    accent: "#00AEEF",
    items: [
      { label: "Basic Decals",  href: "/packages/base-decal",   dot: "#00AEEF" },
      { label: "Partial Wraps", href: "/packages/partial-wrap", dot: "#EC008C" },
      { label: "Full Wraps",    href: "/packages/full-wrap",    dot: "#FFD700" },
    ],
  },
  {
    ...
    accent: "#F97316",
    items: [
      { label: "Murals & Wall Decals",        href: "/specialty", dot: "#F97316" },
      { label: "Window Graphics & Perf",      href: "/specialty", dot: "#F97316" },
      { label: "Professional Window Tint",    href: "/specialty", dot: "#F97316" },
      { label: "Fleet Packages",              href: "/specialty", dot: "#ffffff" },
      { label: "Installation",                href: "/specialty", dot: "#ffffff" },
      { label: "Graphic Design",              href: "/specialty", dot: "#ffffff" },
    ],
  },
];
      ...
      <div className="hidden lg:block border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1.5 flex items-center justify-between">
          <p className="text-[11px] text-gray-500 tracking-wide font-medium">
            Waterloo&nbsp;•&nbsp;Kitchener&nbsp;•&nbsp;Guelph&nbsp;•&nbsp;Cambridge&nbsp;•&nbsp;Brantford&nbsp;•&nbsp;London&nbsp;•&nbsp;Goderich&nbsp;•&nbsp;Welland
          </p>
        ...
        <div className="flex items-center justify-between h-28">
          ...
          <Link href="/" className="flex items-center gap-3 min-w-0">
            <Image
              ...
              style={{ transform: "scale(1.8)", transformOrigin: "left center", marginLeft: "-6px" }}
              priority
            />
            <div className="hidden xl:flex relative z-10 flex-col justify-center border-l border-white/15 pl-3" style={{ marginLeft: "270px" }}>
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                <span className="text-[8px] font-bold uppercase tracking-widest bg-[#FA8072] text-white px-1.5 py-0.5 rounded-full leading-none">
                  V8.0
                </span>
              </div>
            </div>
          ...
          <nav className="hidden md:flex items-center gap-7">
            ...
            {navLinks.map((l) => (
              ...
              >
                {l.label}
                {l.badge && (
                  <span className="absolute -top-2.5 -right-5 text-[8px] font-bold bg-[#1D4ED8] text-white px-1.5 py-0.5 rounded-full uppercase tracking-wide leading-none">
                    {l.badge}
                  </span>
                )}
              </Link>
          ...
          <div className="hidden md:block shrink-0">
            <Link
              ...
              style={{ background: "repeating-linear-gradient(-45deg, #00AEEF 0px, #00AEEF 22px, #EC008C 22px, #EC008C 44px, #FFD700 44px, #FFD700 66px)", color: "#fff", textShadow: "0 1px 3px rgba(0,0,0,0.55)" }}
            >
              Build Your Wrap
            </Link>
          </div>
          ...
          >
            <div className="px-4 pb-4 pt-2 flex flex-col gap-2">
              ...
              <Link
                href="/calculator"
                onClick={() => setMenuOpen(false)}
                className="mt-2 inline-flex items-center justify-center text-sm font-semibold px-5 py-3 rounded-full"
                style={{ background: "repeating-linear-gradient(-45deg, #00AEEF 0px, #00AEEF 22px, #EC008C 22px, #EC008C 44px, #FFD700 44px, #FFD700 66px)", color: "#fff", textShadow: "0 1px 3px rgba(0,0,0,0.55)" }}
              >
                Build Your Wrap
              </Link>
