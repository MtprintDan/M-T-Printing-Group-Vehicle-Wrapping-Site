    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-12 bg-gray-50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 sm:px-10">
          <div className="mb-6">
            <h2 className="text-xl font-black text-brand-black">Available Package Sizes</h2>
            <p className="text-sm text-gray-500 mt-1">This package is available for all vehicle sizes below.</p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            {[
              { label: "Standard Vehicle",  description: "Cars, SUVs & Compact Pickups",       sqft: "120–180 sq ft",  image: "/vehicle-sizing-options/Small.png"    },
              { label: "Medium Vehicle",    description: "F-150, Silverado, Transit Connect",  sqft: "180–275 sq ft",  image: "/vehicle-sizing-options/Medium.png"   },
              { label: "Large Vehicle",     description: "Transit, Sprinter, Promaster",       sqft: "275–375 sq ft",  image: "/vehicle-sizing-options/Large.png"    },
              { label: "Oversized Vehicle", description: "Cube Vans & Commercial Trucks",      sqft: "375–700+ sq ft", image: "/vehicle-sizing-options/Oversized.png"},
              { label: "Enclosed Trailer",  description: "Enclosed trailers & semi combos",    sqft: "400–800+ sq ft", image: "/vehicle-sizing-options/Trailer.png"  },
            ].map((v) => (
              <div
                key={v.label}
                className="rounded-xl border border-gray-200 bg-white p-4 text-center flex flex-col items-center"
              >
                ...
                <div
                  ...
                  style={{ backgroundColor: pkg.color }}
                />
                <p className="font-bold text-sm text-brand-black leading-tight">{v.label}</p>
                <p className="text-[11px] text-gray-500 mt-1 leading-snug">{v.description}</p>
                <p className="text-[10px] font-semibold text-gray-400 mt-1">{v.sqft}</p>
              </div>
            ))}
          </div>
        </div>
